...
setwd("C:/Users/21004751/OneDrive - Massey University/Student Projects - Aline Parolin Calarga PhD Project - Aline Parolin Calarga PhD Project/Thesis/Chapter 03 Salmonella/WRITING_CHAPTER03/Figures_scripts/6B_SNP_count_Give/")
getwd()
...
#==============================================================================#
#We have two periods: 2005
#period B: 2019 onwards

# Step 3: Process to add to "longmatrix_Give_ST654.csv" the period
# For isolates where period1 == period2: same_period = 0
# For isolates where period1 != period2: same_period = 1
...
pdf("snpdist_Give_diffperiod.pdf", width = 15, height = 8, onefile = TRUE)
print(p_combined)
dev.off()
