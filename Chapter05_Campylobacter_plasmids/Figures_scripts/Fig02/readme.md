...
#### Input files
Excel file with plasmid markers./n
[plasmid markers for *jejuni*](./jejuni_markers.csv)/n
Excel file with metadata for boxplot/n
[boxplot](./boxplot_jejuni.csv)/n
Output file/n
[output](./fig02_j.pdf)/n
